...
def chat(messages: list[dict]) -> dict:
    ...
    prompt = (
        SYSTEM_PROMPT
        + "\n\nAVAILABLE CATALOG ITEMS (use ONLY these URLs and names):\n"
        + catalog_context
        + "\n\nCONVERSATION HISTORY:\n"
        + conversation_text
        + "\n\nRespond as SHL Assessment Advisor. Output valid JSON only, no markdown."
    )
    ...
    try:
        ...
        result = {
            "reply": "I had trouble formatting my response. Could you rephrase?",
            "recommendations": [],
            "end_of_conversation": False,
        }
